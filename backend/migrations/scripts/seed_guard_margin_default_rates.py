...
async def seed_guard_margin_default_rates() -> None:
    ...
    result = await BillingManager.get_instance().save_guard_margin_rates(payload, current_user=None)
    print("Guard margin default rate seeder completed")
    print(result)


if __name__ == "__main__":
    asyncio.run(seed_guard_margin_default_rates())